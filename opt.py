...
transform.transform_data ("/home/julfy/work/ml-tloe/serps/results/*", 'expanded', 0)

data = load.read_data_sets ('expanded/*',0.3,0.1, num = 0);

model.train_once (data, 0.03, 500000, 0, ermul=10, H1=50, H2=50)
